...
void disks() {
    ...
    world.add(make_shared<disk>(point3(-2,-2, 0), vec3(4, 0, 0), vec3(0, 4, 0), back_green));
    world.add(make_shared<disk>(point3( 3,-2, 1), vec3(0, 0, 4), vec3(0, 4, 0), right_blue));
    world.add(make_shared<disk>(point3(-2, 3, 1), vec3(4, 0, 0), vec3(0, 0, 4), upper_orange));
    world.add(make_shared<disk>(point3(-2,-3, 5), vec3(4, 0, 0), vec3(0, 0,-4), lower_teal));
...
void cornell_box() {
    ...
    cam.render(world , lights, "cornell_box");
}
...
void final_scene() {
    ...
    cam.aspect_ratio      = 1.0;
    cam.image_width       = 800; //high res = 800   , low rez = 400
    cam.samples_per_pixel = 10000; //high res = 10000 , low rez = 250
    cam.max_depth         = 40;   //high res = 40    , low rez = 4
    cam.background        = color(0,0,0);
    cam.numThreads        = 24;
